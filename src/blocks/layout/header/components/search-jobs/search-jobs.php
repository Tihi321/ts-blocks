...
<form role="search" method="get" class="header__search js-header-serach" action="<?php echo esc_url( home_url( '/jobs' ) ); ?>" >
  <div class="header__search-field">
    <input type="text" value="<?php echo get_search_query(); ?>" name="name" id="name" class="header__search-input js-search-jobs-input input" placeholder="<?php esc_html_e( 'Search Jobs', 'ts-blocks' ); ?>" />
