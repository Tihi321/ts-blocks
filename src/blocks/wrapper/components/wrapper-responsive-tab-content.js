...
export const WrapperResponsiveTabContent = (props) => {
  ...
  const spacingOptions = [
    ...
    { label: __('Great (300px)', 'ts-blocks'), value: 'great' },
    { label: __('Gigantic (280px)', 'ts-blocks'), value: 'gigantic' },
    { label: __('Gargantuan (260px)', 'ts-blocks'), value: 'gargantuan' },
    { label: __('Extensive (240px)', 'ts-blocks'), value: 'extensive' },
    { label: __('Enormous (220px)', 'ts-blocks'), value: 'enormous' },
    { label: __('Colossal (200px)', 'ts-blocks'), value: 'colossal' },
    { label: __('Hugest (180px)', 'ts-blocks'), value: 'hugest' },
    { label: __('Huger (160px)', 'ts-blocks'), value: 'huger' },
    { label: __('Huge (140px)', 'ts-blocks'), value: 'huge' },
    { label: __('Giant (120px)', 'ts-blocks'), value: 'giant' },
    ...
    { label: __('None (0px)', 'ts-blocks'), value: 'no-spacing' },
  ];
  ...
  return (
    <Fragment>
        ...
        <RangeControl
          label={
            <Fragment>
              ...
              {__('Content Width', 'ts-blocks')}
            </Fragment>
          }
          help={__('Change block width in columns range. Example 6 = 50% screen width.', 'ts-blocks')}
          value={contentWidth}
        ...
        <SelectControl
          label={
            <Fragment>
              ...
              {__('Content Offset', 'ts-blocks')}
            </Fragment>
          }
          help={__('Change content position inside a block.', 'ts-blocks')}
          value={contentOffset}
          options={[
            { label: __('Not Set', 'ts-blocks'), value: '' },
            { label: __('Content Spacing', 'ts-blocks'), value: 'content-spacing' },
            { label: __('Content Spacing Small', 'ts-blocks'), value: 'content-spacing-small' },
            { label: __('Right Edge', 'ts-blocks'), value: 'right-edge' },
        ...
        <SelectControl
          label={
            <Fragment>
              ...
              {__('Container Width', 'ts-blocks')}
            </Fragment>
          }
          help={__('Change Container width. Changing this option will affect total width for Content Width option.', 'ts-blocks')}
          value={containerWidth}
          options={[
            { label: __('Not Set', 'ts-blocks'), value: '' },
            { label: __('Default', 'ts-blocks'), value: 'default' },
            { label: __('Big', 'ts-blocks'), value: 'big' },
          ]}
        ...
        <SelectControl
          label={
            <Fragment>
              ...
              {__('Container Spacing', 'ts-blocks')}
            </Fragment>
          }
          help={__('Change Container spacing on the left and right.', 'ts-blocks')}
        ...
        <SelectControl
          label={
            <Fragment>
              ...
              {__('Spacing Top', 'ts-blocks')}
            </Fragment>
          }
          help={__('Change Block Spacing from the top.', 'ts-blocks')}
          value={spacingTop}
        ...
        <SelectControl
          label={
            <Fragment>
              ...
              {__('Spacing Bottom', 'ts-blocks')}
            </Fragment>
          }
          help={__('Change Block Spacing from the bottom.', 'ts-blocks')}
          value={spacingBottom}
          options={spacingOptions}
      ...
      {onChangeHideBlock &&
        <ToggleControl
          label={__('Hide Block', 'ts-blocks')}
          help={__('Toggle block visibility.', 'ts-blocks')}
          checked={hideBlock}
